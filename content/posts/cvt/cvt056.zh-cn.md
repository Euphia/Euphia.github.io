...
Neutral 是一个覆盖面非常广泛的嗓音模式，涵盖许多不同的声音和音色。这种声音比金属模式的声音更轻柔、温和。初学阶段可以通过放松下颌来找到 Neutral。
...
### 放松下颌 Loose jaw
初学阶段要确保下巴放松，以避免触发非自主收缩和可能的 "咬住的动作"，因为 "咬住的动作 "可能会诱使你发出金属音。（与 "咬住的动作 "的比较，请参阅 "找到"咬住的动作"。
