...
大量的 twang最适合元音'EE'（如在'see'中），"I" ("sit" [ɪ])），"EH" ("stay" [ɛ])，"OE" ("herb" [ɜr])和"A" ("and" [æ])，因为在这些情况下，舌头位于口腔上部的臼齿上，这有助于下压会厌漏斗。 "OH"（如在'so'中），"O"（如在'woman'中），"OO" ("you" [u])和'AH'（如在'far'中）不太好制造大量的 twang，因为在这些元音中，舌根降低导致你丢失会厌漏斗的 twang。加入大量的 twang 之后，"OH"，"O"，"OO"变得听起来更像"OE" ("herb" [ɜr])。 "OH"（如在'so'中）变为'OEH'。 "O"变为'OE'。 "OO"变为'OOE'。 'AH'变为"A"。
